...
/// Type alias for a 33-byte compressed secp256k1 public key represented using the `Inner` type
/// with fixed-size configuration (prefix byte + 32-byte X coordinate).
pub type PubKey33<'a> = Inner<'a, true, 33, 0, 0>;
